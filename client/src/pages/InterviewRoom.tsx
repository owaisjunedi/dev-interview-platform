          ...
          <Panel defaultSize={25} minSize={20} maxSize={40}>
            <div className="h-full flex flex-col border-r border-border bg-card/30">
              <Tabs value={leftTab} onValueChange={setLeftTab} className="flex-1 flex flex-col">
                <TabsList className={`mx-2 mt-2 grid w-auto ${role === 'interviewer' ? 'grid-cols-3' : 'grid-cols-2'}`}>
                    ...
                    {selectedQuestion ? (
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Solve the "{selectedQuestion.title}" problem using your preferred approach.
                      ...
                      <div className="h-full flex items-center justify-center text-center text-muted-foreground">
                        <div>
                          ...
                          <p className="text-xs mt-1">Go to "Top 10" tab to generate questions</p>
                        </div>
                      </div>
                    )}
                  </ScrollArea>
                    ...
                    <TabsContent value="notes" className="flex-1 m-0 p-3 overflow-hidden">
                      <div className="h-full flex flex-col">
                        ...
                        <Textarea
                          ...
                          placeholder="Add your observations, feedback, and scores here..."
